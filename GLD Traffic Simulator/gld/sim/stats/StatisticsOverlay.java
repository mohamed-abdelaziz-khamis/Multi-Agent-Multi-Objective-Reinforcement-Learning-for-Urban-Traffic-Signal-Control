...
/**
*
* Overlay for <code>gld.View</code>. 
* Shows waiting queue lengths and relative average junction waiting times.
*
* @author Group GUI
* @version 1.0
*/
...
public class StatisticsOverlay implements Overlay, Observer, XMLSerializable
{
	...
	public void refreshData()
	{
		...
		for(int i=0; i<junctionNum; i++)
			if((junctionData[i] = junctions[i].getStatistics(0).getAvgDelay(true)) > junctionMax) 
