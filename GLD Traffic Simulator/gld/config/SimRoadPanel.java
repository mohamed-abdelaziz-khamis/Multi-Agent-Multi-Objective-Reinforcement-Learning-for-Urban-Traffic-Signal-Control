...
public class SimRoadPanel extends ConfigPanel implements ActionListener, ItemListener
{
	...
	public SimRoadPanel(ConfigDialog cd, Road r)
	{
		...
		//SBC
		speed = new Label();
		speed.setBounds(0, 150, 250 /*EJUST comment 200*/, 20);
		add(speed);
		
		artery = new Label();
		artery.setBounds(0, 175, 200, 20);
		add(artery);
	...
	public void setRoad(Road r) {
		...
		//SBC
		speed.setText("The maximum allowed speed is " + road.getSpeedMaxAllowed());
		artery.setText("This road is primary: " + road.isPrimary());
	}
