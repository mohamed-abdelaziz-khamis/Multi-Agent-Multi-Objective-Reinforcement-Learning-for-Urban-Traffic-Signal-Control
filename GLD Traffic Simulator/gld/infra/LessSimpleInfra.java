...
public class LessSimpleInfra extends Infrastructure
{
	public LessSimpleInfra()
	{
		...
		try {
			...
			{
				SpawnFrequency sf = new SpawnFrequency(1,(float) 0.2, -1 /*EJUST*/, null /*EJUST*/, -1 /*EJUST*/, 1 /*EJUST*/, 0 /*EJUST*/);
				SpawnFrequency[] sfa = {sf};
				edge1.setSpawnFrequencies(sfa);
			}
	
			{
				SpawnFrequency sf = new SpawnFrequency(1,(float) 0.1, -1 /*EJUST*/, null /*EJUST*/, -1 /*EJUST*/, 1 /*EJUST*/, 0 /*EJUST*/);
				SpawnFrequency[] sfa = {sf};
				edge2.setSpawnFrequencies(sfa);
			}
	
			{
				SpawnFrequency sf = new SpawnFrequency(1,(float) 0.3, -1 /*EJUST*/, null /*EJUST*/, -1 /*EJUST*/, 1 /*EJUST*/, 0 /*EJUST*/);
				SpawnFrequency[] sfa = {sf};
