...
/**
 *
 * TrackingView that tracks the average trip stops count.
 *
 * @author  EJUST
 * @version 1.0
 */

public class TotalStopsCountTrackingView extends ExtendedTrackingView
{
	NodeStatistics[][] stats;
	
	public TotalStopsCountTrackingView(int startTimeStep, SimModel model)
	{
		super(startTimeStep);
	...
	{ 
		...
		for(int i=0; i<stats.length; i++) {
			...
			sample += stats[i][index].getAvgStopsCount(allTime) * ru;
			count += ru;
		}
	...
	public String getDescription() { return "average trip stops count"; }
