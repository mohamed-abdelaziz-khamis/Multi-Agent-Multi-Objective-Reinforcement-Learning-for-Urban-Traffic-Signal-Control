...
public class ACGJ3FixedValue extends TLController implements InstantiationAssistant,XMLSerializable, Constants /*EJUST*/
{
	...
	{
		if(_prevsign == _signnow && (_prevpos-_posnow)<=STOP_SPEED_MS*TIMESTEP_S /*EJUST replaced: _prevpos==_posnow */) {
	...
	{ 	
		...
		{ 
			throw new ClassNotFoundException ("ACGJ3 IntstantiationAssistant cannot make instances of "+  request);
		}
	}
