...
/**
 *
 * TrackingView that tracks the average waiting time of one Junction.
 *
 * @author  EJUST
 * @version 1.0
 */

public class JunctionWaitingTimeTrackingView extends ExtendedTrackingView
{
	NodeStatistics[] stats;
	int id;
	
  public JunctionWaitingTimeTrackingView(int startTimeStep, Junction junction)
  {
		super(startTimeStep);
