...
/**
 *
 * TrackingView that tracks the average trip delay.
 *
 * @author  Group GUI
 * @version 1.0
 */

public class TotalDelayTrackingView extends ExtendedTrackingView
{
	NodeStatistics[][] stats;
	
	public TotalDelayTrackingView(int startTimeStep, SimModel model)
	{
		super(startTimeStep);
	...
	public String getDescription() { return "average trip delay"; }
