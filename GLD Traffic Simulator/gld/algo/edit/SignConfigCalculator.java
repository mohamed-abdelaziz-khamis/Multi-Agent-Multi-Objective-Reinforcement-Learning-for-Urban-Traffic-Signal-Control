...
public class SignConfigCalculator
{
	...
	*/
	...
	{
		Vector possibleConfigs = new Vector();  // This list contains all possible Configurations
	...
	private class Config
	{
		...
		public boolean configAllowed() throws InfraException
		{
			...
			// Check each pair of configuration whether there are collisions or not
		...
		// Determines whether this configuration is a subset of the configuration "cfg"
