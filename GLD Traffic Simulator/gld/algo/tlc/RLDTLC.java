 ...
 *
 * This controller will switch TrafficLights so that the Trafficlight with the shortest queue of waiting Roadusers will get set to green.
 *
...
{	
	 ...
	 * The longer the queue, the higher the Q-value.
	 */	
