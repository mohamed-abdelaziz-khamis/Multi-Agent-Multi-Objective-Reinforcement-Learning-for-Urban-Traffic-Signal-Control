 ...
 * @version 1.2
 */
public class SL6TLC extends TCRL implements InstantiationAssistant, Constants /*EJUST*/
{  
    ...
    */
	...
	public void updateRoaduserMove(
	            Roaduser ru, Drivelane prevlane, Sign prevsign, double prevpos /*EJUST: int --> double*/, 
    ...
    protected void recalcQ(Sign tl, double pos /*EJUST: int --> double*/, 
        ...
        try
        {
            ...
            e_table[tl.getId()][pos_int][destination.getId()][light?green_index:red_index] = 1;
