...
public class ACGJ4 extends TLController implements InstantiationAssistant,XMLSerializable, Constants /*EJUST*/
{
	...
	{ 	
		...
		{ 
			throw new ClassNotFoundException("ACGJ4 InstantiationAssistant cannot make instances of "+  request);
		}
	}
