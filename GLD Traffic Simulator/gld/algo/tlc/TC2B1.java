 ...
 * @version 0.1
 */
public class TC2B1 extends TCRL implements Colearning,InstantiationAssistant, Constants /*EJUST*/
{
	// TLC vars
	...
	*/
	 ...
	 */
	protected void relaxBucket(Drivelane prevlane, double prevpos /*EJUST: int --> double*/) {
	...
	*/
	...
	protected int calcReward(int tlId, double pos /*EJUST: int --> double*/, int tlNewId, 
