...
/**
 *
 * TrackingView that tracks the total variance speed of all roadusers that either have/haven't arrived yet.
 *
 * @author  EJUST
 * @version 1.0
 */

public class TotalVarianceSpeedTrackingView extends ExtendedTrackingView
{
	NodeStatistics[][] stats;
	DrivelaneSpeedStatistics[][] drivelaneSpeedStats;	
	
	public TotalVarianceSpeedTrackingView(int startTimeStep, SimModel model)
	{
		super(startTimeStep);
	...
	public String getDescription() { return "variance speed"; }
	
	protected String getYLabel() { return "variance speed (meter/timestep)"; }
}