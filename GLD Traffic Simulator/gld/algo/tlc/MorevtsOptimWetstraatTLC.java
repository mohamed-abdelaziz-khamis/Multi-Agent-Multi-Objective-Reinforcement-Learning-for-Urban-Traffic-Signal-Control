...
public class MorevtsOptimWetstraatTLC extends TLController implements Constants /*EJUST*/ {
	public int PERIOD = 90 ;
	
	public final static String shortXMLName="Green Waves (Optim)for Wetstraat";
	
	/** EJUST: Position update time step*/
	protected static final double dt = TIMESTEP_S;
	
	public MorevtsOptimWetstraatTLC(Infrastructure infra) 
	{	
		super(infra);
		//setPhaseDiffs();
	}
