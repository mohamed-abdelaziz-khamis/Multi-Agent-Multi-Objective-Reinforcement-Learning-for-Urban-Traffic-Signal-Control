 ...
 * @version 1.1
 */
public class SL4TLC extends TCRL implements InstantiationAssistant, Constants /*EJUST*/
{   
...
//OBS       // Her burde laves et tjek p� om 0 < gamma < 1 og det samme med random chance
    ...
    {   
        ...
        { 
        	throw new ClassNotFoundException("SL4 IntstantiationAssistant cannot make instances of "+ request);
        }
    }
}