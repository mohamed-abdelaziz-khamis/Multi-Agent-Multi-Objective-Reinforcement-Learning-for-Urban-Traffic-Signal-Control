...
public class DPFactory
{
	...
	/** Makes a new DPFactory for a specific SimModel and TLC 
	  ...
	  * @param tlc The traffic light controller to cooperate with
	 */
	...
	/** Looks up the id of a DP algorithm by its description
	  ...
	  * @throws NoSuchElementException If there is no algorithm with that description.
	 */
	...
	*/
  	 ...
  	 * This method is meant to be used for loading.
   	*/
