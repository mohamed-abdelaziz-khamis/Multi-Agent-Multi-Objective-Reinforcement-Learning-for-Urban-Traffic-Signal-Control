...
public class EditController extends Controller
{
  ...
  public void setEditModel(EditModel m) { model = m; }
	...
	{  if (!filename.endsWith(".infra"))
		...
		//GASTON: AGREGUE ESTE CODIGO PARA CARGAR TODOS LOS NODOS DISPONIBLES CUANDO CARGA LA RED EL GLDEDIT.
		//TAMBIEN VA A CARGAR LOS IDS DE TODOS LOS DRIVELANES EN LOS LANESTATISTICS
		/*
		 * Add this code to load all available nodes 
		 * LOAD WHEN THE NETWORK WILL ALSO CHARGE GLDEDIT IDS IN ALL DRIVELANES LANESTATISTICS
		 * */
