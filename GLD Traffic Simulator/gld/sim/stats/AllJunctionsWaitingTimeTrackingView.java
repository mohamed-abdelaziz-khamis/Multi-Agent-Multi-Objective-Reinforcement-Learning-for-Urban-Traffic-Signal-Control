...
public class AllJunctionsWaitingTimeTrackingView extends ExtendedTrackingView
{
	NodeStatistics[][] stats;
	
	public AllJunctionsWaitingTimeTrackingView(int startTimeStep, SimModel model)
	{
		super(startTimeStep);
