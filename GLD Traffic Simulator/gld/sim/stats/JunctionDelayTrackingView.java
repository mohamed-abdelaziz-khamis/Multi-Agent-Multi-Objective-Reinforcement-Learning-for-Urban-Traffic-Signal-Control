...
/**
 *
 * TrackingView that tracks the average delay of one Junction.
 *
 * @author  Group GUI
 * @version 1.0
 */

public class JunctionDelayTrackingView extends ExtendedTrackingView
{
	NodeStatistics[] stats;
	int id;
	
  public JunctionDelayTrackingView(int startTimeStep, Junction junction)
  {
		super(startTimeStep);
	...
	public String getDescription() { return "junction " + id + " - average junction delay"; }
