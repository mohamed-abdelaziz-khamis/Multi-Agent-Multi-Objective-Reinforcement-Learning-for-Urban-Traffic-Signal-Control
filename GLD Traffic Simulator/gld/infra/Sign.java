...
public abstract class Sign implements XMLSerializable, TwoStageLoader
{
	...
	/** SBC: last timeStep when switched green */
	public int timeStepSwitched =-10;
	...
	/** SBC: returns the last timeStep when sign was switched green */
	public int getTimeStepSwitched() { return timeStepSwitched; }
	/** SBC: sets the timeStep when sign is switched green */
	public void setTimeStepSwitched(int c) { timeStepSwitched = c; }
