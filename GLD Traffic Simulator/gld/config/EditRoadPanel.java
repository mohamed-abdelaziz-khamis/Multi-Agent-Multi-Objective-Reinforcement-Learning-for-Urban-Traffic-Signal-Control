...
public class EditRoadPanel extends ConfigPanel implements ActionListener, ItemListener
{
	...
	public EditRoadPanel(ConfigDialog cd, Road r)
	{
		...
		//SBC: For maximum allowed speed on this road.
		Label speedlab = new Label("Maximum allowed speed:");
		speedlab.setBounds(0,250,150,20);
		add(speedlab);
		
		speed = new TextField(); // see SimRoadPanel for implementation
		speed.setBounds(150, 250, 40, 20);
		speed.addActionListener(this);
		add(speed);
		
		setSpeed = new Button("Set"); 
		setSpeed.addActionListener(this);
		setSpeed.setBounds(200, 250, 50, 20);
		add(setSpeed);
		
		//SBC: For the primary property 
		artery = new Checkbox("This road is primary");
		artery.setBounds(0, 275, 150, 20);
		artery.addItemListener(this);
		add(artery);
	...
	public void setRoad(Road r) {
		...
		//SBC
		speed.setText(Double.toString(road.getSpeedMaxAllowed())); /*EJUST: Int --> Double*/
		artery.setState(road.isPrimary());
	}
	...
	public void setSpeed() {
		double sp = Double.parseDouble(speed.getText()); /*EJUST: int --> double*/
		road.setSpeedMaxAllowed(sp);
	}
	
	//SBC
	public void setPrimary() {
		road.setPrimary(artery.getState());
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		// SBC: for maximum allowed speed at this road
