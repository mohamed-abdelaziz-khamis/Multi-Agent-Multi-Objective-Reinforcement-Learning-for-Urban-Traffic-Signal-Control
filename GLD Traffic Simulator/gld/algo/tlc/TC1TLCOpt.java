 ...
 * @version 2.0
 */
public class TC1TLCOpt extends TCColearnPerformanceIndex implements Colearning, InstantiationAssistant, HECinterface, Constants /*EJUST*/
{
	// TLC vars
	...
	{	
		...
		for(int t=0; t < num_posmovs; t++) {		// For All tl', pos'
			...
			if(p_index >= 0) {
				...
				//	PEntry P_AJWT = new PEntry(tlId, pos, i, light, curPMTlId, curPMPos);
