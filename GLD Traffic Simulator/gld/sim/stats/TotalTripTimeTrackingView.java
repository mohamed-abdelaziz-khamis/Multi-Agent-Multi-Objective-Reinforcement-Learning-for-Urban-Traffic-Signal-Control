...
/**
 *
 * TrackingView that tracks the average trip time.
 *
 * @author  EJUST
 * @version 1.0
 */

public class TotalTripTimeTrackingView extends ExtendedTrackingView
{
	NodeStatistics[][] stats;
	
	public TotalTripTimeTrackingView(int startTimeStep, SimModel model)
	{
		super(startTimeStep);
	...
	{ 
		...
		for(int i=0; i<stats.length; i++) {
			...
			sample += stats[i][index].getAvgTripTime(allTime) * ru;
			count += ru;
		}
	...
	public String getDescription() { return "average trip time"; }
