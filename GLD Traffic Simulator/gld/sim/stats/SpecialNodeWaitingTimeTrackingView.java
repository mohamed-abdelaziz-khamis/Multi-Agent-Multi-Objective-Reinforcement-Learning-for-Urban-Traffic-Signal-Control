...
/**
 *
 * TrackingView that tracks the average trip waiting time of one Special node
 *
 * @author  EJUST
 * @version 1.0
 */

public class SpecialNodeWaitingTimeTrackingView extends ExtendedTrackingView
{
	NodeStatistics[] stats;
	int id;
	
  public SpecialNodeWaitingTimeTrackingView(int startTimeStep,SpecialNode node)
  {	
	  super(startTimeStep);
	...
	protected String getYLabel() { return "waiting time (time steps)"; }
}
