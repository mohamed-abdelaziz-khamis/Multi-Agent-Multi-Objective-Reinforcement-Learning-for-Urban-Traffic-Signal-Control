...
{
	protected static final int WIDTH = 450; /*EJUST*/; //400;
	protected static final int HEIGHT = 450 /*SBC*/; //350;
	...
	public ConfigDialog(Controller con)
	{
		...
		cpf = new PanelFactory(this, con instanceof SimController ? PanelFactory.TYPE_SIM : PanelFactory.TYPE_EDIT);
