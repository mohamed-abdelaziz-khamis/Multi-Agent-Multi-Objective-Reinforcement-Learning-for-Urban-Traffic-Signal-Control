...
/**
 *
 * TrackingView that tracks the average delay of all Junctions.
 *
 * @author  Group GUI
 * @version 1.0
 */

public class AllJunctionsDelayTrackingView extends ExtendedTrackingView
{
	NodeStatistics[][] stats;
	
	public AllJunctionsDelayTrackingView(int startTimeStep, SimModel model)
	{
		super(startTimeStep);
	...
	{ 
		...
		for(int i=0; i<stats.length; i++) {
			...
			sample += stats[i][index].getAvgDelay(allTime) * ru;
			count += ru;
		}
	...
	public String getDescription() { return "average junction delay"; }
