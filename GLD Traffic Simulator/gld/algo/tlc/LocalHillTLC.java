...
public class LocalHillTLC extends TLController implements Colearning
{
	...
	*/
	...
	public void updateRoaduserMove(Roaduser ru, Drivelane currentlane, Sign currentsign, double prevpos /*EJUST: int --> double*/, 
			Drivelane nextlane, Sign nextsign, double posnow /*EJUST: int --> double*/, 
	...
	/* If this road user is on the first position in the road, this one is used for calcing. We want to know his new direction (node, tl)
		if(prevpos<=STOP_SPEED_MS*TIMESTEP_S  && currentlane != null && nextlane != null) {
